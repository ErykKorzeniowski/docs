...
namespace csrefLINQExamples
{
    ...
    class ImplicitlyTypedArraySample
    {
    	static void Main()
    	{
    		...
    		// Accessing first element which should be "1"
    		Console.WriteLine("First element: " + a[0]);
    
    		// Accessing first element which should be "10"
    		Console.WriteLine("Second element: " + a[1]);
    
    		// Accessing first element which should be "100"
    		Console.WriteLine("Third element: " + a[2]);
    
    		// Accessing first element which should be "1000"
    		Console.WriteLine("Fourth element: " + a[3]);
    
    
    		var b = new[] { "hello", null, "world" }; // string[]
    
    			// Accessing elements of an array using 'string.Join' method, should display "hello  world"
